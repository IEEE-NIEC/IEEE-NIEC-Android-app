...
public class MainActivity extends AppCompatActivity
        ...
        , OnUserProfileInteractionListener, OnHomeSliderInteractionListener {
    ...
    private boolean loadUserFragmentAfterEditing = false;
        ...
        switch (menuItemId) {
            ...
            case R.id.nav_my_profile:
                ...
                if(firebaseUser != null){
                    mUser = ContentUtils.getUserDataFromShredPref(this);
                    if(mUser != null){
                        ft.setCustomAnimations(android.R.anim.slide_in_left, android.R.anim.slide_out_right,android.R.anim.slide_in_left, android.R.anim.slide_out_right);
    ...
    @Override
    public void onSearchUserFragmentInteraction(FirestoreUser user) {
    ...
    @Override
    public void editProfile(FirestoreUser user) {
